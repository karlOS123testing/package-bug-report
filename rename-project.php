...
searchDirectoryFiles(getcwd() . '/', 'package-bug-report', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'PackageBugReport', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Package Bug Report', dashesToCamelCase($argv[1], true, ' '));
