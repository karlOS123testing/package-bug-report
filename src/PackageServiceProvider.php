...
namespace ProcessMaker\Package\PackageBugReport;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use ProcessMaker\Package\Packages\Events\PackageEvent;
use ProcessMaker\Package\PackageBugReport\Http\Middleware\AddToMenus;
use ProcessMaker\Package\PackageBugReport\Listeners\PackageListener;

class PackageServiceProvider extends ServiceProvider
{
    // Assign the default namespace for our controllers
    protected $namespace = '\ProcessMaker\Package\PackageBugReport\Http\Controllers';
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../resources/views/', 'package-bug-report');

        $this->publishes([
            __DIR__ . '/../public' => public_path('vendor/processmaker/packages/package-bug-report'),
        ], 'package-bug-report');
